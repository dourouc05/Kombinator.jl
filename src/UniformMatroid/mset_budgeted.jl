...
"""
struct BudgetedUniformMatroidInstance
  ...
  function BudgetedUniformMatroidInstance(values::Vector{Float64}, weights::Vector{Int}, m::Int;
...
values(i::BudgetedUniformMatroidInstance) = i.values
weights(i::BudgetedUniformMatroidInstance) = i.weights
m(i::BudgetedUniformMatroidInstance) = i.m
budget(i::BudgetedUniformMatroidInstance) = i.budget
max_weight(i::BudgetedUniformMatroidInstance) = i.max_weight

value(i::BudgetedUniformMatroidInstance, o::Int) = values(i)[o]
values(i::BudgetedUniformMatroidInstance, o) = values(i)[o]
weight(i::BudgetedUniformMatroidInstance, o::Int) = weights(i)[o]
weights(i::BudgetedUniformMatroidInstance, o) = weights(i)[o]
dimension(i::BudgetedUniformMatroidInstance) = length(values(i))

struct BudgetedUniformMatroidSolution
  instance::BudgetedUniformMatroidInstance
...
function value(s::BudgetedUniformMatroidSolution)
  return sum(s.instance.values[i] for i in s.items)
end

function items(s::BudgetedUniformMatroidSolution, budget::Int)
  return s.solutions[s.instance.m, 0, budget]
end

function items_all_budgets(s::BudgetedUniformMatroidSolution, max_budget::Int)
...
function value(s::BudgetedUniformMatroidSolution, budget::Int)
  its = items(s, budget)
  if -1 in its
    return -Inf
  end
